...
4. **Bayesian validation** confirms robust model convergence and predictive accuracy
:::
...
We engineered a `phonologically_distinct` variable to operationalize the theoretical mechanism of "indeterminacy".
